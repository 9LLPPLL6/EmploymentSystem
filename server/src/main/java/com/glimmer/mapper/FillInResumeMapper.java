...
public interface FillInResumeMapper {
    ...
    void fillInResumeBaseInfo(@Param("baseInfo") BaseInfo baseInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeBaseInfo(@Param("foreignKey") Integer foreignKey);
    /**
     * 填写简历教育信息
     * @param educationInfo
     * @param foreignKey
    ...
    void deleteResumeEducationInfo(@Param("foreignKey") Integer foreignKey);
    ...
    void fillInResumeClubInfo(@Param("clubInfo") ClubInfo clubInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeClubInfo(@Param("foreignKey") Integer foreignKey);
    ...
    void fillInResumePositionInfo(@Param("positionInfo") PositionInfo positionInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumePositionInfo(@Param("foreignKey") Integer foreignKey);
    /**
     * 填写简历奖学金信息
    ...
    void fillInResumeScholarshipInfo(@Param("scholarshipInfo") ScholarshipInfo scholarshipInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeScholarshipInfo(@Param("foreignKey") Integer foreignKey);
    ...
    void fillInResumeSocialActInfo(@Param("socialactInfo") SocialactInfo socialactInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeSocialInfo(@Param("foreignKey") Integer foreignKey);
    /**
     * 填写简历单个工作经历
    ...
    void fillInResumeWorkExperienceInfo(@Param("workExperienceEntity") WorkExperienceEntity workExperienceEntity, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeWorkExperienceInfo(@Param("foreignKey") Integer foreignKey);
    /**
     * 填写简历单个项目经历
     * @param projectInfo
     * @param foreignKey
    ...
    void fillInResumeProjectExperienceInfo(@Param("projectInfo") ProjectInfo projectInfo, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeProjectExperienceInfo(@Param("foreignKey") Integer foreignKey);
    /**
     * 保存简历pdf的url
     * @param url
     * @param foreignKey
    ...
    void saveResumeUrl(@Param("url") String url, @Param("foreignKey") Integer foreignKey);
    ...
    void deleteResumeUrl(@Param("foreignKey") Integer foreignKey);
    ...
    PdfUrl[] getResumePdfUrl(@Param("foreignKey") Integer foreignKey);
}
